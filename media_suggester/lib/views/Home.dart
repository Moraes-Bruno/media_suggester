      ...
      verificarExisteRecomendacoes(user!.uid).then((value) async {
        if (!value) {
          ...
          Suggestion _suggestion =
              new Suggestion(null, null);

          List<dynamic> sugestoes_series =
              await _suggestion.GerarSugestoes(
                      "series",
                      preferencias_series
          ...
          _suggestion =
          new Suggestion(sugestoes_filmes, sugestoes_series);
  ...
  Future<Widget?> _carregarMedias(Suggestion? sugestoes) async {
    try {
      ...
      if (mounted) {
        ...
        var generosFilmes =
            await _media.fetchGeneros(firstAirDate: null);
        var generosSeries =
            await _media.fetchGeneros(firstAirDate: "123");
